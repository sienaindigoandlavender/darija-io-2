...
export default function CategoryClient({ words, categories, currentSlug, currentName, description, locale }: Props) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="px-8 md:px-[8%] lg:px-[12%] pt-20 pb-12">
        ...
        <p className="text-[#c53a1a] text-xs font-medium uppercase tracking-[0.3em] mb-4">{tCat('wordsCount', { count: words.length })}</p>
